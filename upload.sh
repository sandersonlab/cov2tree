...
#python3 treeshears.py -i public-latest.all.masked.pb -o public-latest.all.masked.sheared.pb -T 5000
...
--clade_types=nextstrain,pango --shear --shear_threshold=5000
